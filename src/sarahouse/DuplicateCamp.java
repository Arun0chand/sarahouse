...
public class DuplicateCamp{
	...
	public void campaignCreation(String campaignName,String subjectLine,String selectAudienceReach,String label) throws InterruptedException {
		JavascriptExecutor js5 = (JavascriptExecutor) driver;
