...
public class ScheduledCampaign{
	...
	public void campaignCreation(String campaignName,String subjectLine,String selectAudienceReach,String HH,String MM) throws InterruptedException {
		JavascriptExecutor js5 = (JavascriptExecutor) driver;
...
//		driver.findElement(By.xpath("//body/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/md-tabs[1]/md-tabs-content-wrapper[1]/md-tab-content[1]/div[1]/div[1]/div[2]/div[3]/div[1]/span[1]/label[1]")).click();
		// Enter the Advertiser cost normal
...
//		driver.findElement(By.xpath("//label[contains(text(),'Start Campaign Immediately')]")).click();
		driver.findElement(By.xpath("//label[contains(text(),'Create a Campaign Schedule')]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//tbody/tr[2]/td[1]/div[1]/input[1]")).clear();
		driver.findElement(By.xpath("//tbody/tr[2]/td[1]/div[1]/input[1]")).sendKeys(HH);
		Thread.sleep(2000);
		driver.findElement(By.xpath("//tbody/tr[2]/td[3]/div[1]/input[1]")).clear();
		driver.findElement(By.xpath("//tbody/tr[2]/td[3]/div[1]/input[1]")).sendKeys(MM);		
		//Campaign Scheduled button Click
		driver.findElement(By.xpath("//button[contains(text(),'Schedule Campaign')]")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//body/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[10]/a[1]")).click();
	}
	...
	public String[][] getData() throws IOException {
		String path = ".\\datafiles\\Scheduled campaign.xlsx";
