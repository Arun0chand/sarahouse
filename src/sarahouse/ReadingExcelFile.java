...
public class ReadingExcelFile {
	...
	public void advertiserOnBoarding(String businessName,String website,String businessVat,String postalCode, String address,
			String companyRegNumber,String subId,String firstName ,String lastName,String jobTitle,String email,String telephone,String validation) throws InterruptedException {
		...
		if(validation == "Valid"){
			...
			driver.findElement(By.xpath("//body/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[3]/div[1]/div[1]/input[1]")).sendKeys(firstName);
			//Last name
			driver.findElement(By.xpath("//body/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[3]/div[1]/div[2]/input[1]")).sendKeys(lastName);
			//Job Title
			driver.findElement(By.xpath("//body/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[3]/div[1]/div[3]/input[1]")).sendKeys(jobTitle);
			//Email Address
			driver.findElement(By.xpath("//input[@id='bill_email_id']")).sendKeys(email);
			//Telephone Number
			driver.findElement(By.xpath("//body/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[3]/div[1]/div[5]/input[1]")).sendKeys(telephone);
	...
	public String [][] getData() {
		String advertiserDataProvider[][] = {
				{"Hardware and ply","WWW.hardware.com","20","560036","Btm","20","21","Anand","k","Hardware","Anand25@active.agency","7349731367","Valid"},
								{"Market World","WWW.marketworld.com","21","560087","HSR Layout","25","35","Rajkumar","R","Market","Anand25@active.agency",  "8867178390","Invalid"},
				//				{"Star World1","WWW.starworld.com","20","560081","BTM Last Stage","29","36","ARUN C","CC","StarWorld","gajee@active.agency","8867178392"},
				//				{"Star World2","WWW.starworld.com","20","560081","BTM Last Stage","29","36","ARUN C","CC","StarWorld","vikas@active.agency","8867178392"},
				//				{"Star World3","WWW.starworld.com","20","560081","BTM Last Stage","29","36","ARUN C","CC","StarWorld","varsha@active.agency","8867178392"},
				//				{"Star World4","WWW.starworld.com","20","560081","BTM Last Stage","29","36","ARUN C","CC","StarWorld","roopa@active.agency","8867178392"},
				//				{"Star World5","WWW.starworld.com","20","560081","BTM Last Stage","29","36","ARUN C","CC","StarWorld","sanjay@active.agency","8867178392"},
				//				{"Star World6","WWW.starworld.com","20","560081","BTM Last Stage","29","36","ARUN C","CC","StarWorld","onkar@active.agency","8867178392"},
				//				
		};
		return advertiserDataProvider;
	}
